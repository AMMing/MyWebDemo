        ...
        aming_line: function(setting, callback) {
            ...
            var col_divs = function(index, count) {
                ...
                for (var i = 0; i < column; i++) {
                    $renderTo.append(col_div(index, i, color));
                }
            };
            ...
            var animate_top = function() {
                ...
                for (var i = 0; i < column; i++) {
                    var $col_items = $renderTo.find('.col_div[index="' + i + '"]');
                    var $items_old = $col_items.filter('.col_div[cindex="' + oldindex + '"]');
                    var $items_new = $col_items.filter('.col_div[cindex="' + newindex + '"]');
                    var time = randomTime();
                    $col_items.css({
                        top: h
                    });
